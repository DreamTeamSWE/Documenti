...
\newcommand{\PdP}{\textit{Piano di Progetto v1.0.1}}
\newcommand{\PdQ}{\textit{Piano di Qualifica v1.0.1}}
\newcommand{\NdP}{\textit{Norme di Progetto v1.0.1}}
\newcommand{\MU}{\textit{Manuale Utente v0.1.0}}
