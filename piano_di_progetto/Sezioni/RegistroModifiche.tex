...
\begin{longtable}{ m{0.1\textwidth}<{\centering}  m{0.13\textwidth}<{\centering}  m{0.2\textwidth}<{\centering}  m{0.14\textwidth}<{\centering}  m{0.3\textwidth}<{\centering} }
	...
	v0.1.4& 2022-01-16 & \MB{} & \AM{} & Correzione delle sezioni §4.3 e §4.4. (Verificatore: \textit{\MG})\\
	
	v0.1.3& 2021-12-15 & \MB{} & \AM{} & Stesura §4.3 e §4.4. (Verificatore: \textit{\MG})\\

	v0.1.2& 2021-12-14 & \EP{} & \RE{} & Aggiunta termini nel glossario. (Verificatore: \textit{\MG})\\
