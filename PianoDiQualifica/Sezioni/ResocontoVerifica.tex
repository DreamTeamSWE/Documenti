...
A causa dell'errore commesso durante il primo periodo nello svolgimento dell'analisi dei requisiti, sono state necessarie più ore lavorative rispetto a quelle preventivate nel secondo periodo.
\begin{figure}[H]
    \centering
...
\begin{table}[H]
    ...
    Gestione della qualità & F & L & L & N & N & N & N & N & N & 1 \\
...
\begin{itemize}
    \item NormeDiProgetto-v1.0.0
    \item PianoDiProgetto-v1.0.0
    \item AnalisiDeiRequisiti-v1.0.0
    \item PianoDiQualifica-v1.0.0
\end{itemize}
