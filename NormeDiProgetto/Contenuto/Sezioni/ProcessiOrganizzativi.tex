...
\item \textbf{Node.js}: \mylink{https://nodejs.org/api/};
\item \textbf{AWS Cognito}: \mylink{https://docs.aws.amazon.com/cognito/latest/developerguide/};
\item \textbf{AWS Comprehend}: \mylink{https://docs.aws.amazon.com/comprehend/};
\item \textbf{API Gateway}: \mylink{https://docs.aws.amazon.com/apigateway/latest/developerguide/};
\item \textbf{AWS Lambda}: \mylink{https://docs.aws.amazon.com/lambda/}.
\end{itemize}
