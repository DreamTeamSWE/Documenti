...
\subsection{Codifica}
\subsubsection{Scopo}
Lo scopo del processo di codifica è l’effettiva realizzazione del prodotto software, svolto dal \textit{\PR}. Si può vedere come la trasformazione in codice dell’architettura definita dai \textit{Progettisti}.
