...
\begin{itemize}
  ...
  \item Casi d'uso relativi alle varie funzionalità fruibili nella piattaforma;
...
\begin{tabular}{ m{0.15\textwidth}<{\centering}  m{0.4\textwidth}<{\centering}  m{0.25\textwidth}<{\centering}  m{0.2\textwidth}<{\centering}}
    \rowcolor{darkblue}
...
\item \textbf{AWS CLI}: uno strumento unificato per la gestione dei servizi AWS via interfaccia a riga di comando.
\end{itemize}
