...
% ------ INIZIO PARTE DA INCLUDERE NELLE NORME -------
...
%(xxx) riferimento: Per una descrizione dettagliata sui vincoli di qualità presi in considerazione si veda il documento \textit{Piano di Qualifica vxx.xxx} in § : Obiettivi e metriche di qualità.
% ------ FINE PARTE DA INCLUDERE NELLE NORME -------
% ------ DA RIMUOVERE -------
\end{document}
% ------ FINE DA RIMUOVERE -------
