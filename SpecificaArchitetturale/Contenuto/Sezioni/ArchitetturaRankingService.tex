...
\begin{itemize}
    ...
    Questo pattern infatti ci permette, nel caso in cui in futuro ci sia bisongo di un algortimo più avanzato per l'analisi dei post, con il minimo sfrozo e modifica del codice, di implementare la nuova classe che erediterà anch'essa dalla classe base Analyzer.
